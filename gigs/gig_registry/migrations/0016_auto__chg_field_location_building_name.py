...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Location.building_name'
        db.alter_column('gig_registry_location', 'building_name', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

    def backwards(self, orm):

        # Changing field 'Location.building_name'
        db.alter_column('gig_registry_location', 'building_name', self.gf('django.db.models.fields.DateField')(max_length=150, null=True))
