...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Note'
        db.create_table('gig_registry_note', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('note_text', self.gf('django.db.models.fields.CharField')(max_length=256)),
        ))
        db.send_create_signal('gig_registry', ['Note'])

        # Adding M2M table for field note on 'Band'
        db.create_table('gig_registry_band_note', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('band', models.ForeignKey(orm['gig_registry.band'], null=False)),
            ('note', models.ForeignKey(orm['gig_registry.note'], null=False))
        ))
        db.create_unique('gig_registry_band_note', ['band_id', 'note_id'])

        # Adding M2M table for field note on 'Venue'
        db.create_table('gig_registry_venue_note', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('venue', models.ForeignKey(orm['gig_registry.venue'], null=False)),
            ('note', models.ForeignKey(orm['gig_registry.note'], null=False))
        ))
        db.create_unique('gig_registry_venue_note', ['venue_id', 'note_id'])

        # Adding M2M table for field note on 'Location'
        db.create_table('gig_registry_location_note', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('location', models.ForeignKey(orm['gig_registry.location'], null=False)),
            ('note', models.ForeignKey(orm['gig_registry.note'], null=False))
        ))
        db.create_unique('gig_registry_location_note', ['location_id', 'note_id'])

        # Adding M2M table for field note on 'Person'
        db.create_table('gig_registry_person_note', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('person', models.ForeignKey(orm['gig_registry.person'], null=False)),
            ('note', models.ForeignKey(orm['gig_registry.note'], null=False))
        ))
        db.create_unique('gig_registry_person_note', ['person_id', 'note_id'])

        # Adding M2M table for field note on 'Gig'
        db.create_table('gig_registry_gig_note', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('gig', models.ForeignKey(orm['gig_registry.gig'], null=False)),
            ('note', models.ForeignKey(orm['gig_registry.note'], null=False))
        ))
        db.create_unique('gig_registry_gig_note', ['gig_id', 'note_id'])


    def backwards(self, orm):
        # Deleting model 'Note'
        db.delete_table('gig_registry_note')

        # Removing M2M table for field note on 'Band'
        db.delete_table('gig_registry_band_note')

        # Removing M2M table for field note on 'Venue'
        db.delete_table('gig_registry_venue_note')

        # Removing M2M table for field note on 'Location'
        db.delete_table('gig_registry_location_note')

        # Removing M2M table for field note on 'Person'
        db.delete_table('gig_registry_person_note')

        # Removing M2M table for field note on 'Gig'
        db.delete_table('gig_registry_gig_note')
    ...
    models = {
        'gig_registry.band': {
            ...
            'note': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['gig_registry.Note']", 'symmetrical': 'False'})
        },
        ...
        'gig_registry.note': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'note_text': ('django.db.models.fields.CharField', [], {'max_length': '256'})
        },
        'gig_registry.owner': {
