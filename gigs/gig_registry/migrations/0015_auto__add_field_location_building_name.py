...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Location.building_name'
        db.add_column('gig_registry_location', 'building_name',
                      self.gf('django.db.models.fields.DateField')(max_length=150, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Location.building_name'
        db.delete_column('gig_registry_location', 'building_name')
    ...
    models = {
        ...
        'gig_registry.location': {
            ...
            'building_name': ('django.db.models.fields.DateField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
            'comment': ('django.db.models.fields.TextField', [], {'max_length': '300', 'blank': 'True'}),
