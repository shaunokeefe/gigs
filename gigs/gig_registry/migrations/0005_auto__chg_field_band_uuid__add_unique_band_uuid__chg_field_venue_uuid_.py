...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('gig_registry_band', 'uuid', self.gf('django.db.models.fields.CharField')(default=0, unique=True, max_length=40))
        # Adding unique constraint on 'Band', fields ['uuid']
        db.create_unique('gig_registry_band', ['uuid'])


        # Changing field 'Venue.uuid'
        db.alter_column('gig_registry_venue', 'uuid', self.gf('django.db.models.fields.CharField')(default=0, unique=True, max_length=40))
        # Adding unique constraint on 'Venue', fields ['uuid']
        db.create_unique('gig_registry_venue', ['uuid'])


        # Changing field 'Location.uuid'
        db.alter_column('gig_registry_location', 'uuid', self.gf('django.db.models.fields.CharField')(default=0, unique=True, max_length=40))
        # Adding unique constraint on 'Location', fields ['uuid']
        db.create_unique('gig_registry_location', ['uuid'])


        # Changing field 'Person.uuid'
        db.alter_column('gig_registry_person', 'uuid', self.gf('django.db.models.fields.CharField')(default=0, unique=True, max_length=40))
        # Adding unique constraint on 'Person', fields ['uuid']
        db.create_unique('gig_registry_person', ['uuid'])


        # Changing field 'Gig.uuid'
        db.alter_column('gig_registry_gig', 'uuid', self.gf('django.db.models.fields.CharField')(default=0, unique=True, max_length=40))
        # Adding unique constraint on 'Gig', fields ['uuid']
        db.create_unique('gig_registry_gig', ['uuid'])


    def backwards(self, orm):
        # Removing unique constraint on 'Gig', fields ['uuid']
        db.delete_unique('gig_registry_gig', ['uuid'])

        # Removing unique constraint on 'Person', fields ['uuid']
        db.delete_unique('gig_registry_person', ['uuid'])

        # Removing unique constraint on 'Location', fields ['uuid']
        db.delete_unique('gig_registry_location', ['uuid'])

        # Removing unique constraint on 'Venue', fields ['uuid']
        db.delete_unique('gig_registry_venue', ['uuid'])
        ...
        # Changing field 'Venue.uuid'
        db.alter_column('gig_registry_venue', 'uuid', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))

        # Changing field 'Location.uuid'
        db.alter_column('gig_registry_location', 'uuid', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))

        # Changing field 'Person.uuid'
        db.alter_column('gig_registry_person', 'uuid', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))

        # Changing field 'Gig.uuid'
        db.alter_column('gig_registry_gig', 'uuid', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))
