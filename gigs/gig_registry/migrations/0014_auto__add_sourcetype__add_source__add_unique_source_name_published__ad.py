...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('gig_registry_sourcetype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=40)),
        ))
        db.send_create_signal('gig_registry', ['SourceType'])

        # Adding model 'Source'
        db.create_table('gig_registry_source', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('source_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gig_registry.SourceType'], null=True, blank=True)),
        ))
        db.send_create_signal('gig_registry', ['Source'])

        # Adding unique constraint on 'Source', fields ['name', 'published']
        db.create_unique('gig_registry_source', ['name', 'published'])

        # Adding field 'Gig.source'
        db.add_column('gig_registry_gig', 'source',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gig_registry.Source'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'Source', fields ['name', 'published']
        db.delete_unique('gig_registry_source', ['name', 'published'])

        # Deleting model 'SourceType'
        db.delete_table('gig_registry_sourcetype')

        # Deleting model 'Source'
        db.delete_table('gig_registry_source')

        # Deleting field 'Gig.source'
        db.delete_column('gig_registry_gig', 'source_id')
