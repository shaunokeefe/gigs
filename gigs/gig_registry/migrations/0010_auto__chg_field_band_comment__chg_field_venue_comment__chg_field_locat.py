...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Band.comment'
        db.alter_column('gig_registry_band', 'comment', self.gf('django.db.models.fields.TextField')(max_length=300))

        # Changing field 'Venue.comment'
        db.alter_column('gig_registry_venue', 'comment', self.gf('django.db.models.fields.TextField')(max_length=300))

        # Changing field 'Location.comment'
        db.alter_column('gig_registry_location', 'comment', self.gf('django.db.models.fields.TextField')(max_length=300))

        # Changing field 'Person.comment'
        db.alter_column('gig_registry_person', 'comment', self.gf('django.db.models.fields.TextField')(max_length=300))

        # Changing field 'Gig.comment'
        db.alter_column('gig_registry_gig', 'comment', self.gf('django.db.models.fields.TextField')(max_length=300))

    def backwards(self, orm):

        # Changing field 'Band.comment'
        db.alter_column('gig_registry_band', 'comment', self.gf('django.db.models.fields.CharField')(max_length=300))

        # Changing field 'Venue.comment'
        db.alter_column('gig_registry_venue', 'comment', self.gf('django.db.models.fields.CharField')(max_length=300))

        # Changing field 'Location.comment'
        db.alter_column('gig_registry_location', 'comment', self.gf('django.db.models.fields.CharField')(max_length=300))

        # Changing field 'Person.comment'
        db.alter_column('gig_registry_person', 'comment', self.gf('django.db.models.fields.CharField')(max_length=300))

        # Changing field 'Gig.comment'
        db.alter_column('gig_registry_gig', 'comment', self.gf('django.db.models.fields.CharField')(max_length=300))
