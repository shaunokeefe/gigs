...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Note.note_text'
        db.alter_column('gig_registry_note', 'note_text', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Note.note_text'
        db.alter_column('gig_registry_note', 'note_text', self.gf('django.db.models.fields.CharField')(max_length=256))
