...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Band.comment'
        db.add_column('gig_registry_band', 'comment',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=300, blank=True),
                      keep_default=False)

        # Adding field 'Location.comment'
        db.add_column('gig_registry_location', 'comment',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=300, blank=True),
                      keep_default=False)

        # Adding field 'Person.comment'
        db.add_column('gig_registry_person', 'comment',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=300, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Band.comment'
        db.delete_column('gig_registry_band', 'comment')

        # Deleting field 'Location.comment'
        db.delete_column('gig_registry_location', 'comment')

        # Deleting field 'Person.comment'
        db.delete_column('gig_registry_person', 'comment')
