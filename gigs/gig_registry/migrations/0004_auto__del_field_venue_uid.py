...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Venue.uid'
        db.delete_column('gig_registry_venue', 'uid')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Venue.uid'
        raise RuntimeError("Cannot reverse this migration. 'Venue.uid' and its values cannot be restored.")
