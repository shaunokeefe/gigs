...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SearchQueryRecord'
        db.create_table('search_searchqueryrecord', (
        ...
        db.send_create_signal('search', ['SearchQueryRecord'])


    def backwards(self, orm):
        # Deleting model 'SearchQueryRecord'
        db.delete_table('search_searchqueryrecord')
    ...
    models = {
        ...
        'search.searchqueryrecord': {
            'Meta': {'object_name': 'SearchQueryRecord'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
